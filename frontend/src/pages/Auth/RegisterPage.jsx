        ...
        <main class="flex-1 relative flex items-center justify-center p-6">
            ...
            <section class="relative z-10 w-full max-w-md">
                ...
                <div class="glass-effect rounded-lg p-10 border border-outline-variant/15 shadow-2xl shadow-indigo-950/50">
                    <div class="mb-8">
                        <h1 class="font-headline text-3xl font-extrabold tracking-tight text-on-surface mb-2">Create Account</h1>
                        <p class="text-on-surface-variant font-body leading-relaxed">Join the multiverse of competitive Tic-Tac-Toang.</p>
                    </div>
                    <form class="space-y-6">
                        ...
                        <DropdownInput
                            ...
                            options={["Vietnam", "United States", "Australia", "Canada"]}
                        />
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-on-surface-variant font-body">
                            ...
                            <a class="text-primary font-semibold underline underline-offset-4 ml-1 hover:text-primary-dim transition-colors" href="/login">Login</a>
                        </p>
                    </div>
                </div>
