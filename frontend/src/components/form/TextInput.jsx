export default function TextInput(props) {
    return (
        <div class="space-y-2 group">
            ...
            <div class="flex items-center bg-surface-container-highest/60 rounded-lg px-4 py-3 border-b-2 border-transparent focus-within:border-primary transition-all input-glow">
                <span class="material-symbols-outlined text-outline mr-3 text-lg">{props.icon}</span>
