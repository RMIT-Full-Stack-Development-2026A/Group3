  ...
  return (
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-8 py-4 bg-slate-950/40 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(16,11,31,0.4)]">
      <div className="flex items-center gap-8">
        <h1 className="text-2xl font-bold bg-gradient-to-br from-indigo-300 to-purple-500 bg-clip-text text-transparent font-headline tracking-tight">
          TicTacToang
        </h1>
      </div>
      
      <div className="flex items-center gap-4">
        <button className="w-10 h-10 rounded-full overflow-hidden border-2 border-primary/30 hover:border-primary transition-colors active:scale-95">
          <img 
            alt="User Avatar" 
