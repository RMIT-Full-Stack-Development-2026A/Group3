    ...
    return (
        <div class="space-y-2 group">
            ...
            <div class="flex items-center bg-surface-container-highest/60 rounded-lg px-3 py-3 border-b-2 border-transparent focus-within:border-primary transition-all input-glow">
                <span class="text-outline mr-3 text-lg">
                    <img src={`public/assets/${props.icon}`} alt="user icon" />
                </span>
                <input
                    class="bg-transparent border-none focus:ring-0 w-full text-on-surface placeholder:text-outline-variant/60"
